                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kembalian" id="" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Bayar</label>
                                    <input type="text" name="total_bayar" id="" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="{{route('tampilkan-data.transaksi')}}" class="btn btn-secondary">Cancel
                                </a>
                            </div>
                        </div>
                </div>
